...
\paragraph{Reproducibility.} Code, data pipelines, and full experimental results are available at \url{https://github.com/IndarKarhana/lda-image-classification}.
